...
| 5 | Knowledge Graph (Neo4j sync + discovery) | done | `/api/graph/discover/` returns nodes |
| 6 | Frontend pages (App Router + wallet UX) | done | End-to-end flow in browser |
| 7 | Smart contracts (Foundry → Base Sepolia) | done | `forge test` passes, vault deploy works |
